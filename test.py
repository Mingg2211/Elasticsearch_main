...
# print(my_es.create_new_index(index_name='mingg_v4'))
...
# print(my_es.insert_document(index_name='minggz', document=doc))
...
# print(my_es.check_number_document(index_name='minggz'))

# print(my_es.search_main(index_name="minggz", query='"nghệ sĩ" + "con gái"', k=5))